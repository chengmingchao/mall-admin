...
-- ----------------------------
BEGIN;
INSERT INTO `wms_purchase` VALUES (1, 2, 'cmc', '17717812314', 1, 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms_purchase` VALUES (2, 1, 'admin', '13612345678', NULL, 1, NULL, NULL, '2020-09-21 09:28:09', '2020-09-21 09:28:09');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `wms_purchase_detail` VALUES (1, 2, 1, 10, NULL, 2, 1);
INSERT INTO `wms_purchase_detail` VALUES (2, 2, 2, 10, NULL, 3, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `wms_ware_info` VALUES (2, '1号仓库', '上海闵行区浦江镇', '123');
INSERT INTO `wms_ware_info` VALUES (3, '2号仓库', '上海浦东新区曹路', '123');
COMMIT;
