...
-- ----------------------------
BEGIN;
INSERT INTO `sms_member_price` VALUES (1, 3, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 3, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (3, 4, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (4, 4, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (5, 5, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (6, 5, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (7, 6, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (8, 6, 3, '银牌会员', 0.0000, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_full_reduction` VALUES (1, 3, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (2, 4, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (3, 5, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (4, 6, 0.0000, 0.0000, NULL);
COMMIT;
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='商品阶梯价格';

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_ladder` VALUES (1, 3, 0, 0.00, NULL, NULL);
INSERT INTO `sms_sku_ladder` VALUES (2, 4, 0, 0.00, NULL, NULL);
INSERT INTO `sms_sku_ladder` VALUES (3, 5, 0, 0.00, NULL, NULL);
INSERT INTO `sms_sku_ladder` VALUES (4, 6, 0, 0.00, NULL, NULL);
COMMIT;
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='商品spu积分设置';
...
INSERT INTO `sms_spu_bounds` VALUES (2, 4, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 5, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 6, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 7, 0.0000, 0.0000, NULL);
COMMIT;
